...
const faqs = [
  {
    ...
    answer: 'Our AI analyzes your job description and profile to create personalized, ATS-optimized cover letters. Simply input your information, select a template, and get a professional cover letter in seconds.',
  },
  {
    question: 'Can I cancel my subscription anytime?',
    answer: 'Yes, you can cancel your Pro subscription at any time. Your access will continue until the end of your current billing period, and you won\'t be charged again.',
  },
  {
    question: 'Are the cover letters ATS-optimized?',
    answer: 'Absolutely! All our templates and AI-generated content are designed to pass Applicant Tracking Systems (ATS) used by most companies today.',
  },
  {
    question: 'What file formats are supported?',
    answer: 'Free users can download PDF files. Pro users get access to both PDF and DOCX formats for maximum compatibility with different application systems.',
  },
  {
    question: 'Is there a free trial for the Pro plan?',
    answer: 'Yes! We offer a 7-day free trial for the Pro plan. You can cancel anytime during the trial period without being charged.',
  },
  {
    question: 'How many cover letters can I generate?',
    answer: 'Free users can generate 3 cover letters per month. Pro users have unlimited generations. Enterprise plans include bulk generation capabilities.',
  },
];
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-on-surface-variant mx-auto mt-6 max-w-3xl text-lg leading-8">
              Choose the perfect plan for your job search journey. Start free and upgrade when you need more features. 
              All plans include ATS-optimized templates and professional formatting.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="bg-surface-container py-16">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-on-surface text-3xl font-bold">Why Choose Our AI Cover Letter Generator?</h2>
